...
## Project Structure
    ...
    ├── pro_service_enterpr_35784  # Django project configurations
...
1. Clone this repo and `cd pro_service_enterpr_35784`
...
2. Clone this repo and `cd pro_service_enterpr_35784`
